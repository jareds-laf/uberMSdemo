...
def getdata(catfile=None,gaiaid=None,starind=None):
    # th5 is the straight table from the h5
    th5 = h5py.File(catfile,'r')

    # cat_i is part of the h5 file that contains the catalog
    cat_i = Table(th5['catalog'][()])

    if gaiaid != None:
        # This is the part of the table with the star
        t = th5[f'{gaiaid}']

        # This is the part of the catalog with the star
        cat_ii = cat_i[cat_i['GAIAEDR3_ID'] == gaiaid]

        # This is the dictionary with the photometry for each filter
...
def getall(gaiaid=None,date=None,cluster=None):
    ...
    datasrcstr = '/Users/pcargile/Astro/mmt/clusters/data/catalogs/data'
