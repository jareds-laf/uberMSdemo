...
def runstar(gaiaid=None,sampdir=None,cluster=None,version='V0',mgtriplet=False,**kwargs):
    ...
    parstr += r'$\log{(g)}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(bfdict["log(g)_a"][0], bfdict["log(g)_a"][2], bfdict["log(g)_a"][3]) + '\n'
    parstr += r'V$_{\bigstar}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ km/s'.format(bfdict["vstar_a"][0], bfdict["vstar_a"][2], bfdict["vstar_a"][3]) + '\n'
    parstr += r'V$_{mic}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ km/s'.format(bfdict["vmic_a"][0], bfdict["vmic_a"][2], bfdict["vmic_a"][3]) + '\n'
    parstr += r'V$_{RV}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ km/s'.format(bfdict["vrad_a"][0], bfdict["vrad_a"][2], bfdict["vrad_a"][3]) + '\n'
    parstr += '--- Secondary --- \n'
    parstr += r'T$_{eff}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ K'.format(bfdict["Teff_b"][0], bfdict["Teff_b"][2], bfdict["Teff_b"][3]) + '\n'
    parstr += r'$\log{(g)}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(bfdict["log(g)_b"][0], bfdict["log(g)_b"][2], bfdict["log(g)_b"][3]) + '\n'
    parstr += r'V$_{\bigstar}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ km/s'.format(bfdict["vstar_b"][0], bfdict["vstar_b"][2], bfdict["vstar_b"][3]) + '\n'
    parstr += r'V$_{mic}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ km/s'.format(bfdict["vmic_b"][0], bfdict["vmic_b"][2], bfdict["vmic_b"][3]) + '\n'
    parstr += r'V$_{RV}$' + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ km/s'.format(bfdict["vrad_b"][0], bfdict["vrad_b"][2], bfdict["vrad_b"][3]) + '\n'
    parstr += '--- System --- \n'
    parstr += r'[Fe/H]'      + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(*bfdict['[Fe/H]_a']) + '\n'
    parstr += r'[a/Fe]'      + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(*bfdict['[a/Fe]_a']) + '\n'
    parstr += r'Dist'        + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$ pc'.format(*bfdict['dist']) + '\n'
    parstr += r'A$_{V}$'     + r' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(*bfdict['Av']) + '\n'
    parstr += r'$q$'     + ' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(*bfdict['mass_ratio']) + '\n'
    parstr += r'V$_{RV}$'     + ' = ${0:.0f}_{{-{1:.0f}}}^{{+{2:.0f}}}$'.format(*bfdict['vrad_sys']) + '\n'
